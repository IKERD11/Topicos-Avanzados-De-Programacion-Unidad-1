...
def main(page: ft.Page):
    ...
    def enviar_datos(e):
        ...
        def cerrar_dialogo(e):
            """Remueve el overlay de la página para cerrar la ventana emergente."""
            if overlay_container in page.overlay:
                page.overlay.remove(overlay_container)
            page.update()

        # Paso 3: Construir la ventana emergente usando overlay
        overlay_container = ft.Container(
            content=ft.Container(
                content=ft.Column([
                    ft.Text("Datos Enviados", weight=ft.FontWeight.BOLD, color="#4D2A32", size=20),
        ...
        # Paso 4: Agregar el overlay a la página y actualizar
